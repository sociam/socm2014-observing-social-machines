...
\title{1,000 Home Telescopes: Observing Social Machines through Personal Data Stores}
...
whether they be for scientific study or commercial application.  In particular,
recent efforts such as \emph{Care.data}~\footnote{Care.data - A Modern Data Service for the NHS \url{http://care.data}}
...
directly relevant to increased collective wellbeing \cite{caredata}.
