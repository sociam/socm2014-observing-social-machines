...
% 2nd. author
\alignauthor
Daniel Alexander Smith\titlenote{}\\
       \affaddr{Web and Internet Science}\\
       \affaddr{University of Southampton}\\
       \affaddr{Southampton, UK}\\
       \email{ds@ecs.soton.ac.uk}
\alignauthor
Ramine Tinati\titlenote{}\\
       \affaddr{Web and Internet Science}\\
       \affaddr{University of Southampton}\\
       \affaddr{Southampton, UK}\\
       \email{rt509@ecs.soton.ac.uk}
\alignauthor
Kieron O'Hara\titlenote{}\\
       \affaddr{Web and Internet Science}\\
       \affaddr{University of Southampton}\\
       \affaddr{Southampton, UK}\\
...
The concept of a Web Observatory~\cite{wobs} was introduced to investigate methods 
and mechanisms by which people, as a collective society, could be effectively studied 
in academic research settings, by archiving and analysing the information traces they 
created online.  As such traces become increasingly rich, driven by both increased use of the Web and the onslaught of c
...
have received widespread criticism (e.g. \cite{RameshNHS}) about its aggregation of millions of Britons'
...
In this position paper, we propose that a technical architecture about the way this sort
of information is handled and stored may be able to resolve this dilemma. In
particular, we introduce the notion of \emph{personal data store} as a core
atomic component in a new kind of web observatory; one that is purely distributed
and in collective control of its potentially milllions (or billions) of participants.
We first approach this idea by outlining the key functions of a Web Observatory 
through what they are meant to achieve, which we follow with a definition of 
Personal Data Stores, including a summary of work done in this space before now.
Then, we follow this up with the technical and societal implications of applying
PDS architectures to building Web Observatories, and ways one might preserve 
anonymity and privacy in such settings.
